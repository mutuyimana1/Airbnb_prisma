 ...
 */
router.post("/", auth_middleware_1.authenticate, auth_middleware_1.requireHost, listings_controller_1.createListing);
/**
 * @swagger
 * /listings/{id}:
 *   put:
 ...
 *         description: Listing not found
 */
router.put("/:id", auth_middleware_1.authenticate, listings_controller_1.updateListing);
/**
 * @swagger
 * /listings/{id}:
 *   delete:
 ...
 *         description: Listing not found
 */
router.delete("/:id", auth_middleware_1.authenticate, listings_controller_1.deleteListing);
